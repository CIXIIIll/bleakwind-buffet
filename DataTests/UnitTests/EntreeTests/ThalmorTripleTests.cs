...
namespace BleakwindBuffet.DataTests.UnitTests.EntreeTests
{
    public class ThalmorTripleTests
    {
                                                                    ...
                                                                    bool includeBacon, bool includeEgg)
        {
            ...
            if (includeBun && includeKetchup && includeMustard && includePickle && includeCheese && includeTomato && includeLettuce && includeMayo && includeEgg && includeBacon) Assert.Empty(tt.SpecialInstructions);
        }
